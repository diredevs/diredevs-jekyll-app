// Generated on 2013-12-05 using generator-jekyllrb 0.4.0
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      stylus: {
        files: ['<%= yeoman.app %>/_styl/**/*.styl'],
        tasks: ['stylus:dist', 'autoprefixer:server']
      },
      autoprefixer: {
